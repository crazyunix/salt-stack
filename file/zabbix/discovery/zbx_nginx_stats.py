...
zabbix_host = '192.168.1.254'   # Zabbix server IP
zabbix_port = 10051         # Zabbix server port
hostname = socket.gethostname() #'mini'  # Name of monitored server, like it shows in zabbix web ui
time_delta = 1              # grep interval in minutes

# URL to nginx stat (http_stub_status_module)
stat_url = 'http://127.0.0.1:80/ngx_status'

# Nginx log file path
nginx_log_file_path = '/var/log/nginx/topka/mini.topka.com.cn.access.log'
